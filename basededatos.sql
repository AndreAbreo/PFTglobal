...
(
    ID_FUNCIONALIDAD     NUMBER(38, 0) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
...
(
    ID_FUNCIONALIDAD NUMBER(38, 0) NOT NULL,
    ID_PERFIL        NUMBER(38, 0) NOT NULL,
    CONSTRAINT pk_funcionalidades_perfiles PRIMARY KEY (ID_FUNCIONALIDAD, ID_PERFIL)
);

ALTER TABLE FUNCIONALIDADES_PERFILES
    ADD CONSTRAINT FK_FUNCIONALIDADES_PERFILES_ON_ID_FUNCIONALIDAD FOREIGN KEY (ID_FUNCIONALIDAD) REFERENCES FUNCIONALIDADES (ID_FUNCIONALIDAD);

ALTER TABLE FUNCIONALIDADES_PERFILES
    ADD CONSTRAINT FK_FUNCIONALIDADES_PERFILES_ON_ID_PERFIL FOREIGN KEY (ID_PERFIL) REFERENCES PERFILES (ID_PERFIL);
...
ALTER TABLE PROVEEDORES_EQUIPOS
    ADD CONSTRAINT FK_PROVEEDORES_PAISES FOREIGN KEY (ID_PAIS) REFERENCES PAISES (ID_PAIS);
