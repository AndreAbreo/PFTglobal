...
(
    ID_OPERACION     NUMBER GENERATED ALWAYS AS IDENTITY (START WITH 1),
    PRIMARY KEY (ID_OPERACION),
    NOMBRE_OPERACION VARCHAR2(30) not null
)
/

-- primary key already defined inline for OPERACIONES
...
(
    ID_INSTITUCION NUMBER GENERATED ALWAYS AS IDENTITY (START WITH 1),
    PRIMARY KEY (ID_INSTITUCION),
    NOMBRE         VARCHAR2(40) not null
)
/

-- primary key already defined inline for INSTITUCIONES
...
-- primary key already defined inline for FUNCIONALIDADES_PERFILES
...
-- primary key already defined inline for PERFILES
...
-- primary key already defined inline for FUNCIONALIDADES

create table TIPOS_INTERVENCIONES
(
    ID_TIPO     NUMBER GENERATED ALWAYS AS IDENTITY (START WITH 1),
...
(
    ID_MARCA NUMBER GENERATED ALWAYS AS IDENTITY (START WITH 1),
...
(
    ID_TELEFONO NUMBER GENERATED ALWAYS AS IDENTITY (START WITH 1),
    ID_USUARIO  NUMBER,
...
(
    ID_AUDITORIA NUMBER GENERATED ALWAYS AS IDENTITY (START WITH 1),
...
-- primary key already defined inline for AUDITORIAS
...
(
    ID_UBICACION   NUMBER GENERATED ALWAYS AS IDENTITY (START WITH 1),
...
-- primary key already defined inline for UBICACIONES
...
(
    ID_INTERVENCION NUMBER GENERATED ALWAYS AS IDENTITY (START WITH 1),
    ID_USUARIO      NUMBER        not null,
...
-- primary key already defined inline for INTERVENCIONES
...
(
    ID_BAJA     NUMBER GENERATED ALWAYS AS IDENTITY (START WITH 1),
    ID_USUARIO  NUMBER                        not null,
    ID_EQUIPO   NUMBER                        not null,
...
(
    ID_MOVIMIENTO NUMBER GENERATED ALWAYS AS IDENTITY (START WITH 1),
    ID_EQUIPO     NUMBER,
    ID_UBICACION  NUMBER,
    FECHA         DATE,
    USUARIO       NUMBER,
...
-- primary key already defined inline for BAJA_UBICACIONES
...
(
    ID_USUARIO       NUMBER GENERATED ALWAYS AS IDENTITY (START WITH 1),
...
-- primary key already defined inline for USUARIOS
...
create table PAISES
(
    ID_PAIS NUMBER GENERATED ALWAYS AS IDENTITY (START WITH 1),
    PRIMARY KEY (ID_PAIS),
    NOMBRE  VARCHAR2(50)                  not null,
    ESTADO  VARCHAR2(20) DEFAULT 'ACTIVO' NOT NULL
)
...
-- primary key already defined inline for PAISES

create table PROVEEDORES_EQUIPOS
(
    ID_PROVEEDOR NUMBER GENERATED ALWAYS AS IDENTITY (START WITH 1),
    NOMBRE       VARCHAR2(30)                  not null,
    ESTADO       VARCHAR2(20) DEFAULT 'ACTIVO' NOT NULL,
    ID_PAIS      NUMBER
)
...
(
    ID_MODELO NUMBER GENERATED ALWAYS AS IDENTITY (START WITH 1),
...
(
    ID_EQUIPO         NUMBER GENERATED ALWAYS AS IDENTITY (START WITH 1),
...
-- primary key already defined inline for EQUIPOS
...
/
    ...
    -- agrego cosas faltantes al script --
    ALTER TABLE FUNCIONALIDADES_PERFILES
    ADD CONSTRAINT UNQ_FUNCIONALIDAD_PERFIL UNIQUE (ID_FUNCIONALIDAD, ID_PERFIL);
...
INSERT INTO PERFILES (NOMBRE_PERFIL, ESTADO) VALUES ('Tecnico', 'ACTIVO');
INSERT INTO PERFILES (NOMBRE_PERFIL, ESTADO) VALUES ('Ingeniero Biomedico', 'ACTIVO');
INSERT INTO PERFILES (NOMBRE_PERFIL, ESTADO) VALUES ('Tecnologo', 'ACTIVO');
INSERT INTO PERFILES (NOMBRE_PERFIL, ESTADO) VALUES ('SuperAdmin', 'ACTIVO');
...
-- agrego usuarios de Ad --
INSERT INTO USUARIOS (CEDULA, NOMBRE, APELLIDO, ID_PERFIL, ID_INSTITUCION, EMAIL, NOMBRE_USUARIO, CONTRASENIA, ESTADO, FECHA_NACIMIENTO)
VALUES ('3246053', 'Clark', 'Ken', 6, 1, 'superman@hospital.local', 'Superman', 'X2y287ow3Vu8ny+xKEn2IQ==:lQjLHVlqh5wOq4tnG1Z+Dm1tH8yzfS3Uge2cmaci/Wk=', 'ACTIVO', TO_DATE('1988-11-10', 'YYYY-MM-DD'));

INSERT INTO USUARIOS (CEDULA, NOMBRE, APELLIDO, ID_PERFIL, ID_INSTITUCION, EMAIL, NOMBRE_USUARIO, CONTRASENIA, ESTADO, FECHA_NACIMIENTO)
VALUES ('47777375', 'Anastasia', 'López', 1, 1, 'administrador@hospital.local', 'anastasia.lopez', 'X2y287ow3Vu8ny+xKEn2IQ==:lQjLHVlqh5wOq4tnG1Z+Dm1tH8yzfS3Uge2cmaci/Wk=', 'ACTIVO', TO_DATE('1992-05-18', 'YYYY-MM-DD'));

INSERT INTO USUARIOS (CEDULA, NOMBRE, APELLIDO, ID_PERFIL, ID_INSTITUCION, EMAIL, NOMBRE_USUARIO, CONTRASENIA, ESTADO, FECHA_NACIMIENTO)
VALUES ('23302285', 'Luisa', 'Martínez', 2, 2, 'auxiliar@hospital.local', 'luisa.martinez', 'X2y287ow3Vu8ny+xKEn2IQ==:lQjLHVlqh5wOq4tnG1Z+Dm1tH8yzfS3Uge2cmaci/Wk=', 'ACTIVO', TO_DATE('1983-09-25', 'YYYY-MM-DD'));

INSERT INTO USUARIOS (CEDULA, NOMBRE, APELLIDO, ID_PERFIL, ID_INSTITUCION, EMAIL, NOMBRE_USUARIO, CONTRASENIA, ESTADO, FECHA_NACIMIENTO)
VALUES ('21832561', 'Ana', 'De Armas', 4, 1, 'ingbiomedico1@hospital.local', 'ana.dearmas', 'X2y287ow3Vu8ny+xKEn2IQ==:lQjLHVlqh5wOq4tnG1Z+Dm1tH8yzfS3Uge2cmaci/Wk=', 'ACTIVO', TO_DATE('2007-07-13', 'YYYY-MM-DD'));

INSERT INTO USUARIOS (CEDULA, NOMBRE, APELLIDO, ID_PERFIL, ID_INSTITUCION, EMAIL, NOMBRE_USUARIO, CONTRASENIA, ESTADO, FECHA_NACIMIENTO)
VALUES ('03167807', 'Marck', 'Anthony', 5, 1, 'tegnologo1@hospital.local', 'marck.anthony', 'X2y287ow3Vu8ny+xKEn2IQ==:lQjLHVlqh5wOq4tnG1Z+Dm1tH8yzfS3Uge2cmaci/Wk=', 'ACTIVO', TO_DATE('2007-07-13', 'YYYY-MM-DD'));

INSERT INTO USUARIOS (CEDULA, NOMBRE, APELLIDO, ID_PERFIL, ID_INSTITUCION, EMAIL, NOMBRE_USUARIO, CONTRASENIA, ESTADO, FECHA_NACIMIENTO)
VALUES ('66028397', 'Mike', 'Tyson', 3, 1, 'tecnico2@hospital.local', 'mike.tyson', 'X2y287ow3Vu8ny+xKEn2IQ==:lQjLHVlqh5wOq4tnG1Z+Dm1tH8yzfS3Uge2cmaci/Wk=', 'ACTIVO', TO_DATE('2007-07-13', 'YYYY-MM-DD'));

INSERT INTO USUARIOS (CEDULA, NOMBRE, APELLIDO, ID_PERFIL, ID_INSTITUCION, EMAIL, NOMBRE_USUARIO, CONTRASENIA, ESTADO, FECHA_NACIMIENTO)
VALUES ('95890997', 'Bruce', 'Wayne', 6, 1, 'finanzas1@hospital.local', 'bruce.wayne', 'X2y287ow3Vu8ny+xKEn2IQ==:lQjLHVlqh5wOq4tnG1Z+Dm1tH8yzfS3Uge2cmaci/Wk=', 'ACTIVO', TO_DATE('2007-07-13', 'YYYY-MM-DD'));
-- =====================================================
...
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (54, 1); -- Aux admin puede ver reportes
    ...
    -- agrego algunas funcionalidades a perfiles corregir hasta que queden bien --
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (1, 1);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (2, 1);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (3, 1);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (4, 1);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (5, 1);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (6, 1);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (7, 1);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (8, 1);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (12, 1);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (13, 1);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (14, 1);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (15, 1);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (43, 1);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (44, 1);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (45, 1);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (46, 1);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (47, 1);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (48, 1);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (49, 1);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (50, 1);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (51, 1);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (52, 1);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (53, 1);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (54, 1);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (55, 1);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (56, 1);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (59, 1);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (60, 1);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (1, 2);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (2, 2);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (3, 2);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (4, 2);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (5, 2);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (6, 2);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (7, 2);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (8, 2);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (12, 2);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (13, 2);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (14, 2);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (15, 2);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (31, 2);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (32, 2);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (33, 2);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (34, 2);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (37, 2);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (38, 2);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (39, 2);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (40, 2);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (42, 2);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (43, 2);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (44, 2);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (45, 2);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (46, 2);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (47, 2);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (48, 2);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (49, 2);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (55, 2);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (56, 2);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (59, 2);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (60, 2);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (66, 2);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (67, 2);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (68, 2);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (69, 2);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (70, 2);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (1, 4);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (3, 4);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (12, 4);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (13, 4);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (14, 4);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (15, 4);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (55, 4);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (56, 4);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (59, 4);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (60, 4);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (1, 5);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (3, 5);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (12, 5);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (13, 5);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (14, 5);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (15, 5);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (55, 5);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (56, 5);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (59, 5);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (60, 5);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (1, 3);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (3, 3);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (12, 3);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (13, 3);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (14, 3);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (15, 3);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (55, 3);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (56, 3);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (59, 3);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (60, 3);
-- Reemplazo del perfil 21 por perfil 6
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (1, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (2, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (3, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (4, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (5, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (6, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (7, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (8, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (9, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (10, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (11, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (12, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (13, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (14, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (15, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (16, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (17, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (18, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (19, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (20, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (21, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (22, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (23, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (24, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (25, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (26, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (27, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (28, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (29, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (30, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (31, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (32, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (33, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (34, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (35, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (36, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (37, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (38, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (39, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (40, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (41, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (42, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (43, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (44, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (45, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (46, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (47, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (48, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (49, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (50, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (51, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (52, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (53, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (54, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (55, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (56, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (57, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (58, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (59, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (60, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (61, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (62, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (63, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (64, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (65, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (66, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (67, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (68, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (69, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (70, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (71, 6);
INSERT INTO FUNCIONALIDADES_PERFILES (ID_FUNCIONALIDAD, ID_PERFIL) VALUES (72, 6);
-- =====================================================
